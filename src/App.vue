  ...
  <div class="app">
    <div v-show="clickedPopUp" class="order-specialist-wrap" @click.self="onClosePopUp()">
      <div class="specialist-popup">
        <span class="form-close" ><img v-lazy="mysrc2" alt="close" @click="onClosePopUp()"></span>
        <OrderSpecialist v-if="partPopUp==1"></OrderSpecialist>
        <ConfirmationSpecialist v-if="partPopUp==2" name="Lionel" img="photo2.png"></ConfirmationSpecialist>
        <AppointmentSpecialist v-if="partPopUp==3" name="Lionel" img="photo2.png"></AppointmentSpecialist>
      </div>
...
<script>
    ...
    import ConfirmationSpecialist from './components/ConfirmationSpecialist';
